_: {
  services = {
    ...
    caddy = {
      virtualHosts = {
        ...
        "xui.hz1.pltanton.dev".extraConfig = ''
  ...
  networking = {
    firewall.allowedTCPPorts = [26602 26603];
    firewall.allowedUDPPorts = [26602 26603];
  };
