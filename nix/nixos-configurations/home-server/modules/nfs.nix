_: {
  services.nfs.server = {
    ...
    exports = ''
      ...
      /media/store/media/books   10.100.0.0/24(rw,async,insecure,nohide,all_squash,anonuid=1040,anongid=1040,no_subtree_check)
      /media/store/media/books   192.168.0.0/24(rw,async,insecure,nohide,all_squash,anonuid=1040,anongid=1040,no_subtree_check)
    '';
  };
}
