{
  ...
  sops.secrets = {
    ...
    "firefly/nordigen-id".owner = config.services.firefly-iii.user;
    "firefly/nordigen-key".owner = config.services.firefly-iii.user;
    "firefly/gocardless-config".owner = config.services.firefly-iii.user;
    "firefly/revolut-config".owner = config.services.firefly-iii.user;
    "firefly/boc-fixer-env" = {};
  };
  ...
  systemd = {
    timers."firefly-iii-data-importer-job" = {
    ...
    services."firefly-iii-data-importer-job" = let
